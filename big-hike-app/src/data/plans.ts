...
export const yogaDays: YogaDay[] = [
  {
    ...
    poses: [
      ...
      { file: 'Seated_forward_.png', label: 'Seated forward fold' },
  ...
  },
  {
    ...
    poses: [
      ...
      { file: 'half-way_fold.png', label: 'Half-way fold' },
  ...
  },
  {
    ...
    poses: [
      ...
      { file: 'warrior-I.png', label: 'Warrior I alt' },
      { file: 'Extended_side_angle.png', label: 'Extended side angle' },
      { file: 'Chair.png', label: 'Chair' },
    ],
  },
...
const weeks1to12Pattern: Array<{ sunday: string; wednesday: string; friday: string }> = [
  { sunday: 'A', wednesday: 'B', friday: 'C' },
  { sunday: 'D', wednesday: 'E', friday: 'F' },
];
